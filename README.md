...
- [China USCI Checker](https://currawongweb.com/verify/china-usci-checker/) - Free browser-side check of the 18-character Unified Social Credit Identifier printed on mainland China business licences: format plus the GB 32100-2015 check digit. No account and no lookup, so it catches transcription errors and crude forgeries before you spend a query elsewhere. It does not prove the company exists or is active.
